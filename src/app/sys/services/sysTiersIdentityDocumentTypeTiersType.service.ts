    ...
    export class SysTiersIdentityDocumentTypeTiersTypeService {

      controller = "sysTiersIdentityDocumentTypeTiersTypes" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( typeTiersTypeId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "typeTiersTypeId" ,
                        new Blob( [ JSON.stringify( typeTiersTypeId) ]  ,{ type: "application/json" } )
                      ) ;
