    ...
    export class SysUserStatusReasonService {

      controller = "sysUserStatusReasons" ;
     ...
     getAll(): Observable<any> {
      ...
      getBySysUserStatus(id): Observable<any> {
        return this.http.get(environment.apiUrl + "/" + this.controller + "/getBySysUserStatus/" + id );
      }
      ...
      //search the entities witch match criterias , sorted and paginated
      searchByStatus(filter,page,pageSize,multiSortMeta,StatusId): Observable<any> {
        let params = "" ;
        let filters_converted = this.utilsService.parseFilterForSearch(filter);
        let sort_converted = this.utilsService.parseSortForSearch(multiSortMeta);
        ...
        params +="&sysUserStatusId="+StatusId ;



        return this.http.get(environment.apiUrl + "/" + this.controller + "/searchByStatus?" + encodeURI(params) );
