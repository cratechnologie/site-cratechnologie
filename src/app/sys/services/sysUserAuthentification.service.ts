    ...
    export class SysUserAuthentificationService {

      controller = "sysUserAuthentifications" ;
     ...
     getAll(): Observable<any> {
      ...
      deleteBulk( ids :  string[] ): Observable<any> {
        ...
        create(
          ...
          data.dateExpiration = ( data.dateExpiration != "" ) ? this.utilsService.parseDateForSearch( data.dateExpiration , "full" ) : "" ;
      ...
      createBulk(data): Observable<any> {
        if( Array.isArray( data) )
        {
          ...
          data[key].dateExpiration = ( data[key].dateExpiration != "" ) ? this.utilsService.parseDateForSearch( data[key].dateExpiration, "full" ) : "" ;
      ...
      createWithMedia( jwtToken ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "jwtToken" ,
                        new Blob( [ JSON.stringify( jwtToken) ]  ,{ type: "application/json" } )
                      ) ;
