    ...
    export class SysTiersDivisionService {

      controller = "sysTiersDivisions" ;
     ...
     //get all the entities
     getAllRoot(): Observable<any> {
       return this.http.get(environment.apiUrl + "/" + this.controller +"/getAllRoot" );
     }
      ...
      create(id  ,data): Observable<any> {
          ...
          let url = (id != null) ? environment.apiUrl + "/" + this.controller + "/"+id : environment.apiUrl + "/" + this.controller  ;
