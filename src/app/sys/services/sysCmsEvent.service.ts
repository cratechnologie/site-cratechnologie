    ...
    export class SysCmsEventService {

      controller = "sysCmsEvents" ;
     ...
     getAll(): Observable<any> {
      ...
      create(data): Observable<any> {
          ...
          data.begin = ( data.begin != "" ) ? this.utilsService.parseDateForSearch( data.begin , "full" ) : "" ;
          data.end = ( data.end != "" ) ? this.utilsService.parseDateForSearch( data.end , "full" ) : "" ;
      ...
      createBulk(data): Observable<any> {
        if( Array.isArray( data) )
        {
          ...
          data[key].begin = ( data[key].begin != "" ) ? this.utilsService.parseDateForSearch( data[key].begin, "full" ) : "" ;
          data[key].end = ( data[key].end != "" ) ? this.utilsService.parseDateForSearch( data[key].end, "full" ) : "" ;
      ...
      createWithMedia( sysCmsStatusId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysCmsStatusId" ,
                        new Blob( [ JSON.stringify( sysCmsStatusId) ]  ,{ type: "application/json" } )
                      ) ;
