    ...
    export class SysComSmsTemplateVarService {

      controller = "sysComSmsTemplateVars" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysComSmsTemplateId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysComSmsTemplateId" ,
                        new Blob( [ JSON.stringify( sysComSmsTemplateId) ]  ,{ type: "application/json" } )
                      ) ;
