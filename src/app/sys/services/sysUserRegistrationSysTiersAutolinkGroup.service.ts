    ...
    export class SysUserRegistrationSysTiersAutolinkGroupService {

      controller = "sysUserRegistrationSysTiersAutolinkGroups" ;
     ...
     getAll(): Observable<any> {
      ...
      //edit the entity attribute id
      updateWithMedia( sysUserRegistrationSysTiersAutolinkGroup ,   publicImageFile ) : Observable<any> {
       ...
       formData.append(
                       "sysUserRegistrationSysTiersAutolinkGroup" ,
                        new Blob( [ JSON.stringify( sysUserRegistrationSysTiersAutolinkGroup) ]  ,{ type: "application/json" } )
                      ) ;


       formData.append( "publicImageFile" , publicImageFile ) ;
