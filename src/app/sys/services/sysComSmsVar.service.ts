    ...
    export class SysComSmsVarService {

      controller = "sysComSmsVars" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysComSmsId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysComSmsId" ,
                        new Blob( [ JSON.stringify( sysComSmsId) ]  ,{ type: "application/json" } )
                      ) ;
