    ...
    export class SysComMailVarService {

      controller = "sysComMailVars" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysComMailId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysComMailId" ,
                        new Blob( [ JSON.stringify( sysComMailId) ]  ,{ type: "application/json" } )
                      ) ;
