    ...
    export class SysCchEntityLinkedPhoneNumberTypeAllowedService {

      controller = "sysCchEntityLinkedPhoneNumberTypeAlloweds" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysDataEntityId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysDataEntityId" ,
                        new Blob( [ JSON.stringify( sysDataEntityId) ]  ,{ type: "application/json" } )
                      ) ;
