    ...
    export class SysUserService {
     ...
     getAll(): Observable<any> {
      ...
      create(data): Observable<any> {
       ...
       editSysRoles( id , data ): Observable<any> {

              return this.http.post(environment.apiUrl + "/" + this.controller + "/editSysRoles/" + id , data);
      }


      deactivate( id , data ): Observable<any> {
      return this.http.post(environment.apiUrl + "/" + this.controller + "/deactivate/" + id , data);
     }

     activate( id , data ): Observable<any> {

        return this.http.post(environment.apiUrl + "/" + this.controller + "/activate/" + id , data);
    }


    resetPassword(  data ): Observable<any> {
          return this.http.post(environment.apiUrl + "/" + this.controller + "/resetPassword"  , data);
        }

        resetPasswordInit( email ) : Observable<any> {
          return this.http.post(environment.apiUrl + "/" + this.controller + "/resetPasswordInit/" + email , null );
        }



        //get the entity by id
        checkPasswordResetRequest( id ): Observable<any> {
          return this.http.get(environment.apiUrl + "/" + this.controller + "/checkPasswordResetRequest/" + id );
        }
