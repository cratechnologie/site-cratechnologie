    ...
    export class SysBusinessCatalogItemCategoryService {

      controller = "sysBusinessCatalogItemCategorys" ;
     ...
     getAllByService(): Observable<any> {
       return this.http.get(environment.apiUrl + "/" + this.controller + "/getAllByService" );
     }

     getAllByProduct(): Observable<any> {
       return this.http.get(environment.apiUrl + "/" + this.controller + "/getAllByProduct" );
     }
