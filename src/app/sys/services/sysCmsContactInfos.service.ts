    ...
    export class SysCmsContactInfosService {

      controller = "sysCmsContactInfoss" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysCmsContactInfosCategoryId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysCmsContactInfosCategoryId" ,
                        new Blob( [ JSON.stringify( sysCmsContactInfosCategoryId) ]  ,{ type: "application/json" } )
                      ) ;
