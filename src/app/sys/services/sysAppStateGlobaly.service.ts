    ...
    export class SysAppStateGlobalyService {

      controller = "sysAppStateGlobalys" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysTiersPartnerRegistred ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysTiersPartnerRegistred" ,
                        new Blob( [ JSON.stringify( sysTiersPartnerRegistred) ]  ,{ type: "application/json" } )
                      ) ;
