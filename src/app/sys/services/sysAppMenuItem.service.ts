    ...
    export class SysAppMenuItemService {

      controller = "sysAppMenuItems" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysDataEntityInstanceId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysDataEntityInstanceId" ,
                        new Blob( [ JSON.stringify( sysDataEntityInstanceId) ]  ,{ type: "application/json" } )
                      ) ;
