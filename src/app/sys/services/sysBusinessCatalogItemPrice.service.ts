    ...
    export class SysBusinessCatalogItemPriceService {

      controller = "sysBusinessCatalogItemPrices" ;
     ...
     getAll(): Observable<any> {
      ...
      search(sysBusinessCatalogItemId,filter,page,pageSize,multiSortMeta): Observable<any> {
        let params = "" ;
        ...
        return this.http.get(environment.apiUrl + "/" + this.controller + "/searchBySysBusinessCatalogItem/"+sysBusinessCatalogItemId+"?" + encodeURI(params) );
      ...
      createWithMedia( sysBillingUnitId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysBillingUnitId" ,
                        new Blob( [ JSON.stringify( sysBillingUnitId) ]  ,{ type: "application/json" } )
                      ) ;
