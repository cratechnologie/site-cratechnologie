    ...
    export class SysComContactUsRequestService {

      controller = "sysComContactUsRequests" ;
     ...
     getAll(): Observable<any> {
      ...
      return this.http.post(environment.apiUrl + "/" + this.controller + "/changeStatus/" + id , data);
     }
