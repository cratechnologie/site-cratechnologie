    ...
    export class SysComMailTemplateVarService {

      controller = "sysComMailTemplateVars" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysComMailTemplateId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysComMailTemplateId" ,
                        new Blob( [ JSON.stringify( sysComMailTemplateId) ]  ,{ type: "application/json" } )
                      ) ;
