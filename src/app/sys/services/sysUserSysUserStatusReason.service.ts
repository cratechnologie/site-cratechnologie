    ...
    export class SysUserSysUserStatusReasonService {

      controller = "sysUserSysUserStatusReasons" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysUserStatusReasonId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysUserStatusReasonId" ,
                        new Blob( [ JSON.stringify( sysUserStatusReasonId) ]  ,{ type: "application/json" } )
                      ) ;
