    ...
    export class SysAppSecurityEntityLinkedSysRoleService {

      controller = "sysAppSecurityEntityLinkedSysRoles" ;
     ...
     getAll(): Observable<any> {
      ...
      createWithMedia( sysRoleId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysRoleId" ,
                        new Blob( [ JSON.stringify( sysRoleId) ]  ,{ type: "application/json" } )
                      ) ;
