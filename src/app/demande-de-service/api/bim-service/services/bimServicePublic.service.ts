...
export class BimServicePublicService {

  controller = "bimServicePublics";
  ...
  //get the all the data need to edit a single entity
  getEditionCreateData(id): Observable<any> {


    return this.http.get(environment.apiUrl + "/" + this.controller + "/getEditionCreateData/" + id);
  ...
  create(
    ...
    return this.http.post(environment.apiUrl + "/" + this.controller + "/create", data);
  ...
  createWithMedia(sysBusinessCatalogItemId, filesMapIds, filesLinkedMapIds, files, filesLinked): Observable<any> {
    ...
    formData.append(
      "sysBusinessCatalogItemId",
      new Blob([JSON.stringify(sysBusinessCatalogItemId)], { type: "application/json" })
    );
