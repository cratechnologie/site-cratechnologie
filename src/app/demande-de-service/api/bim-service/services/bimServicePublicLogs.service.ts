    ...
    export class BimServicePublicLogsService {

      controller = "bimServicePublicLogss" ;
     ...
     //get all the entities
     getAllByBimServicePublicId( bimServicePublicId ): Observable<any> {
       return this.http.get(environment.apiUrl + "/" + this.controller +"/getAllByBimServicePublicId/"+bimServicePublicId);
     }
      ...
      createWithMedia( sysTiersModificationId ,  filesMapIds , filesLinkedMapIds , files , filesLinked ) : Observable<any> {
       ...
       formData.append(
                       "sysTiersModificationId" ,
                        new Blob( [ JSON.stringify( sysTiersModificationId) ]  ,{ type: "application/json" } )
                      ) ;
